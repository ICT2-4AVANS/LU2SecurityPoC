...
| ----------------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| Vertrouwelijkheid | Hoog        | Afspraakgegevens kunnen herleidbaar zijn naar patiënten. Een afspraak kan indirect medische context onthullen, bijvoorbeeld via afspraaktype, locatie of zorgverlener. | ![alt text](images/image-3.png)  |
| Integriteit       | Zeer hoog   | Afspraakgegevens moeten correct zijn. Een verkeerde patiënt, tijd, zorgverlener of status kan het zorgproces verstoren.                                                | ![alt text](images/image-9.png)  |
| Beschikbaarheid   | Hoog        | Zorgmedewerkers moeten afspraken, roosters en de patient queue kunnen gebruiken. Als de module niet beschikbaar is, wordt het plannen van zorg verstoord.              | ![alt text](images/image-10.png) |
...
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------- | --------------------------------------------------------------- |
| Patiëntafspraken                | Bevat informatie over welke patiënt wanneer zorg ontvangt.                                                            | Vertrouwelijkheid + integriteit | ![alt text](images/image-1.png)                                 |
| Patiëntkoppeling                | Een afspraak wordt gekoppeld aan een specifieke patiënt. Hierdoor zijn afspraakgegevens herleidbaar naar een persoon. | Vertrouwelijkheid               | ![alt text](images/image-2.png)                                 |
| Zorgverlenerroosters            | Bepaalt wanneer zorgverleners beschikbaar zijn voor afspraken.                                                        | Integriteit + beschikbaarheid   | ![alt text](images/image-3.png)                                 |
| Tijdsloten / appointment blocks | Bepalen wanneer afspraken ingepland kunnen worden. Fouten hierin kunnen leiden tot verkeerde planning.                | Integriteit + beschikbaarheid   | ![alt text](images/image-4.png) ![alt text](images/image-5.png) |
| Afspraaktypes                   | Het type afspraak kan medische context verraden.                                                                      | Vertrouwelijkheid               | ![alt text](images/image-6.png)                                 |
| Locatiegegevens                 | De locatie bepaalt waar een afspraak plaatsvindt. Een verkeerde locatie kan leiden tot gemiste afspraken.             | Integriteit                     | ![alt text](images/image-7.png)                                 |
| Afspraakstatussen               | De status geeft aan of een afspraak gepland, afgerond, geannuleerd of gemist is.                                      | Integriteit                     | ![alt text](images/image-8.png)                                 |
