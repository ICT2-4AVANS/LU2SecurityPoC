...
| A.8.15 – Logging en monitoring                        | B-06 – Ontbrekende logging van auth-events / anonieme DWR-calls in `DWRAppointmentService.java`        | Enes     | `docs/auditreport/05-pentest-bevindingen.md` en `docs/auditreport/02gapanalyselogging.md`                                         | `docs/fixes/fix/b06-enes.md`    | PR #83             | Screenshots vóór fix van vier DWR-methoden, screenshots na fix met WARN-logregels, `DWRAppointmentServiceAuthLoggingTest`, testuitkomst met 8 geslaagde testcases                                     | Opgelost                        | Anonieme DWR-calls worden niet meer stil genegeerd. Bij een niet-geauthenticeerde call wordt nu een WARN-logregel geschreven zonder PII, zodat verdachte of ongeautoriseerde aanroepen zichtbaar worden in logs.                                             |
| A.8.15 – Logging en monitoring                        | B-08 – PII via debug-logging in `AppointmentDataSetEvaluator.java`                                     | Rami     | `docs/auditreport/05-pentest-bevindingen.md` en `docs/auditreport/02gapanalyselogging.md`                                         | `docs/fixes/fix/b08-Rami.md`    | PR #79             | Screenshot kwetsbare debug-log vóór fix, screenshot aangepaste logging na fix, controle dat patiëntgerelateerde waarden niet meer direct in debug-logs worden geschreven, test- of buildbewijs na fix | Opgelost                        | De debug-logging is aangepast zodat patiëntgerelateerde waarden en indirect herleidbare PII niet meer direct in logs terechtkomen. Hierdoor is het risico op onnodige blootstelling van patiëntgegevens via debug-logging verlaagd.                          |
...
| B-06 Ontbrekende logging van auth-events | Opgelost |
| B-08 PII via debug-logging               | Opgelost |

Voor A.8.15 zijn B-05, B-06 en B-08 opgelost. B-05 is opgelost door de risicovolle methode met PII-logging volledig te verwijderen. B-06 is opgelost door anonieme DWR-calls te loggen met WARN-logregels zonder PII. B-08 is opgelost door debug-logging aan te passen zodat patiëntgerelateerde waarden en indirect herleidbare PII niet meer direct worden gelogd.
...
| B-06 fixdocument      | `docs/fixes/fix/b06-enes.md`                 | Bewijs voor logging van anonieme DWR-calls in `DWRAppointmentService.java`.               |
| B-07 fixdocument      | `docs/fixes/fix/b07-amine.md`                | Bewijs voor CSRF-fix in DWR-laag.                                                         |
| B-08 fixdocument      | `docs/fixes/fix/b08-Rami.md`                 | Bewijs voor oplossen van PII via debug-logging in `AppointmentDataSetEvaluator.java`.     |
...
| PR #79                | GitHub Pull Request #79                      | Code-artefact voor B-08.                                                                  |
| PR #81                | GitHub Pull Request #81                      | Documentatie-update waarin B-08 als opgelost is verwerkt.                                 |
| PR #83                | GitHub Pull Request #83                      | Code-artefact voor B-06.                                                                  |
